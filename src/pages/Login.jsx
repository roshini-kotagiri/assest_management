      ...
      <div className="auth__container">
        <div className="auth__card">
          <div className="auth__header">
            ...
            <p className="auth__subtitle">Sign in to access your portfolio</p>
          </div>
        ...
        <div className="auth__info">
          <div className="auth__info-content">
            <h2>Secure Access to Your Portfolio</h2>
            <p>
              Access real-time analytics, performance dashboards, and comprehensive 
